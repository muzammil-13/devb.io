    ...
    <Page style={styles.page}>
      <View style={styles.section}>
        <Text style={styles.headerSection}>
          {(data.linkedin_profile.basic_info.full_name || data.name)
            .split(" ")
        ...
        <View style={styles.iconsContainer}>
          ...
          <Link
            style={styles.link}
            src={data.linkedin_profile.basic_info.profile_url}
          >
            Linkedin
          </Link>
        </View>
      ...
      {data.linkedin_profile.experience.length > 0 && (
        <View style={styles.section}>
          ...
          {data.linkedin_profile.experience
            .slice(0, 3)
      ...
      {data.linkedin_profile.education.length > 0 && (
        <View style={styles.section}>
          ...
          {data.linkedin_profile.education
            .slice(0, 1)
            .map((education, index) => (
              <View key={index} style={styles.section}>
      ...
      <View style={styles.section}>
        ...
        {data.achievements.total_contributions > 1 && (
          <Text style={styles.text}>
            Total Contributions: {data.achievements.total_contributions}
          </Text>
        )}
        {data.achievements.issues_closed > 1 && (
          <Text style={styles.text}>
            Issues Closed: {data.achievements.issues_closed}
          </Text>
        )}
        {data.public_repos > 1 && (
          <Text style={styles.text}>
        ...
        {data.achievements.repositories_contributed_to > 1 && (
          <Text style={styles.text}>
            ...
            {data.achievements.repositories_contributed_to}
          </Text>
        )}
        {data.achievements.pull_requests_merged > 1 && (
          <Text style={styles.text}>
            Pull Requests Merged: {data.achievements.pull_requests_merged}
          </Text>
        )}
      </View>
      <View style={styles.section}>
        <Text style={styles.disclaimerText}>
          *Autogenerated via{" "}
          <Link style={[styles.link, { fontSize: 7 }]} src="https://devb.io">
            devb.io
          </Link>
        </Text>
      </View>
  ...
  return {
    ...
    achievements: {
      ...
      repositories_contributed_to:
        userProfile?.achievements.repositories_contributed_to || 0,
